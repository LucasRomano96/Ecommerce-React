...
export const products = [
    ...
    {
        id: "002",
        tittle:"Chainsaw man 01",
        price: formatNumber(1000),
        pictureUrl: "https://res.cloudinary.com/dtaya5wmp/image/upload/v1667923457/Ecommerce-React/Chainsaw-man-01_kmhvkv.jpg",
        description:"En esta historia el pibe motosierra es Denji, que pasa sus días laburando de Devil Hunter y viviendo en la extrema pobreza junto a su demonio Pochita, hasta que ciertos sucesos lo transforman en una verdadera máquina de matar. ¿Cómo hace un cazador de demonios para combatirlos alojando a uno en su interior?",
        stock: 15,
        category: "shonen"
    },
    {
        id:"003",
        tittle:"Death Note 01",
        price: formatNumber(1000),
        pictureUrl: "https://res.cloudinary.com/dtaya5wmp/image/upload/v1667923468/Ecommerce-React/deathnote01_jgcutr.jpg",
    ...
    },
    {
        ...
        tittle:"Monster 01",
        price: formatNumber(1000),
        pictureUrl: "https://res.cloudinary.com/dtaya5wmp/image/upload/v1667923490/Ecommerce-React/Monster-01_eeyw2o.jpg",
        description:"Kenzo Tenma es un cirujano japonés que vivía en Alemania ganando chapa y prestigio hasta que se cruza en su camino Johan Liebert, un niño al que elige salvarle la vida en vez de a un importante político, lo que le cuesta mucho más que el trabajo. Al poco tiempo, una serie de misteriosos asesinatos en el hospital que parecen beneficiar a Tenma hacen que el metódico inspector Lunge lo tenga como principal sospechoso. Nueve años más tarde, Tenma se ve envuelto en una nueva serie de crímenes que lo llevarán a enfrentarse con sus decisiones del pasado: alguien está asesinando ancianos en sus hogares y la única pista surge de uno de los sospechosos que termina internado donde trabaja Tenma.",
        stock: 21,
        category: "seinen"
    },
    {
